...
export default function DetailPinjaman(props) {
    ...
    if(!data || loading){
        ...
        dataKu.push(<p key={0}>Tidak ada Detail Utang Karyawan</p>)
    }else if(data.getDetailPinjaman !== null){
        dataKu.push(
    ...
    return (
        <Container className="containerKu">
            <Row>
                <Col>
                    <BiIcons.BiArrowBack size="50" onClick={() => history.push({pathname: '/permintaan/permintaan pinjaman'})} className="iconBack"/>
                </Col>
            </Row>
